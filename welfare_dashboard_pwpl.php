...
if (isset($_POST['assign_to_me'])) {
    ...
    try {
        $stmt = $pdo->prepare("UPDATE feedback_pwpl SET assigned_admin_id = ? WHERE employee_id = ?");
        ...
        header('Location: welfare_dashboard_pwpl.php?tab=' . $active_tab);
        exit;
...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        LEFT JOIN feedback_pwpl f ON wa.id = f.assigned_admin_id
        WHERE wa.id = ?
        GROUP BY wa.id
    ");
    $stmt->execute([$admin_id]);
...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <div class="sidebar-title">Welfare Admin PWPL</div>
    ...
    <div class="modal" id="actionModal">
        <div class="modal-content">
            ...
            <form id="actionForm" method="POST" action="take_action_pwpl.php">
    ...
    <div class="modal" id="escalateModal">
        <div class="modal-content">
            ...
            <form id="escalateForm" method="POST" action="escalate_case_pwpl.php">
    ...
    <script>
        ...
        document.getElementById('actionForm').addEventListener('submit', function(e) {
            e.preventDefault();
            submitForm(this, 'take_action_pwpl.php');
        });

        document.getElementById('escalateForm').addEventListener('submit', function(e) {
            e.preventDefault();
            submitForm(this, 'escalate_case_pwpl.php');
        });
    </script>
</body>
</html>