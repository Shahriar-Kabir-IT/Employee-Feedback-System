...
try {
    ...
    $stmt = $pdo->prepare("SELECT mood, resolution_progress FROM feedback_pwpl WHERE employee_id = ? ORDER BY timestamp DESC LIMIT 1");
    ...
    $stmt = $pdo->prepare("
        INSERT INTO feedback_pwpl (employee_id, mood, timestamp, resolved, resolution_progress, resolution_timestamp) 
