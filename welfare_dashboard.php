...
if (isset($_POST['assign_to_me'])) {
    ...
    try {
        ...
        header('Location: welfare_dashboard.php?tab=' . $active_tab);
        exit;
...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        LEFT JOIN feedback_abm f ON wa.id = f.assigned_admin_id
        WHERE wa.id = ?
        GROUP BY wa.id
    ");
    $stmt->execute([$admin_id]);
...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <div class="sidebar-title">Welfare Admin ABM</div>
    ...
    <div class="modal" id="actionModal">
        <div class="modal-content">
            ...
            <form id="actionForm" method="POST" action="take_action.php">
