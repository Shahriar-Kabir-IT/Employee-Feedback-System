...
try {
    ...
    $stmt = $pdo->prepare("SELECT mood, resolution_progress FROM feedback_abm WHERE employee_id = ? ORDER BY timestamp DESC LIMIT 1");
    ...
    $stmt = $pdo->prepare("
        INSERT INTO feedback_abm (employee_id, mood, timestamp, resolved, resolution_progress, resolution_timestamp) 
